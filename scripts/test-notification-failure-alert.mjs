...
assert.equal(alert.title, "문자 수신 실패 · 머무룸2");
assert.equal(alert.message, "홍길동 · 7월 23일 14:00~17:00 예약\n사유: 통신사 수신 거절");
...
assert.equal(midnightAlert.message, "김머무 · 7월 23일 21:00~7월 24일 00:00 예약\n사유: 문자 수신 실패");
