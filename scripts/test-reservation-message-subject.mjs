...
assert.equal(reservationMessageSubject("머무룸1"), "머무룸1 이용 안내");
assert.equal(reservationMessageSubject("머무룸2 - 4층"), "머무룸2 이용 안내");
assert.equal(reservationMessageSubject("머무룸3"), "머무룸3 이용 안내");
