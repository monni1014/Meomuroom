...
assert.equal(reservationMessageSubject("머무룸1"), "머무룸1 - 3층 이용안내");
assert.equal(reservationMessageSubject("머무룸2 - 4층"), "머무룸2 - 4층 이용안내");
assert.equal(reservationMessageSubject("머무룸3"), "머무룸3 - 지하1층 이용안내");
